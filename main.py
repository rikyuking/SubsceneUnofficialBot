...
load_dotenv()
bot_token = os.environ.get('ISI BOT TOKEN'))
api = int(os.environ.get('TELEGRAM API'))
hash = os.environ.get('TELEGRAM HASH'))
...
def start(client,message):
    kb = [[InlineKeyboardButton('My Boss🛡', url="https://t.me/XXYZ")]]
    reply_markup = InlineKeyboardMarkup(kb)
    app.send_message(chat_id=message.from_user.id, text=f"Hello saya, adalah__**Subtitle Downloader Bot**__.\kirim saya nama film/Series dan akan saya ambilkan dari__**Subscene**__.\n\n"
...
@app.on_message(filters.command('DONASI'))
